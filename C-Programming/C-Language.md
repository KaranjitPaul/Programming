...
This is the navigation page for the C concepts and practice completed so far.

Parent: [Programming](../Programming.md)

## Chapters

1. [C Basics](01Basics/C-Basic.md) - first C programs, variables, data types, input, constants, comments, and compiler basics
2. [C Instructions And Operators](02Instructions&Operators/C-instructions_operators.md) - declarations, arithmetic, type conversion, precedence, and associativity
...
- [C Projects](Projects/Projects.md) - small programs that combine multiple C topics
